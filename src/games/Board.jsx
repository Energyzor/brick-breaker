...
//import { getBrickColor } from "./util/GetBrickColor";
...
export default function Board() {
  ...
  useEffect(() => {
    const render = () => {
      ...
      let newBrickSet = new Brick(player.level, bricks, canvas, brickObj);
      ...
      // Check all broken
      let allBroken = AllBroken(bricks, player, canvas, ballObj);
      if (allBroken) {
